...
async fn set_campaign_level_rewards_hash() -> anyhow::Result<()> {
    let map: HashMap<i32, (i32, Reward)> = HashMap::from([
        (1, (300, Reward::Enlist(ArmyName::MinuteMenMilitia))),
        (2, (400, Reward::Enlist(ArmyName::PeacekeeperMonks))),
        (3, (1000, Reward::Gold)),
        (4, (500, Reward::Enlist(ArmyName::AmazonianHuntresses))),
        (5, (1200, Reward::Gold)),
        (6, (600, Reward::Enlist(ArmyName::NorthWatchLongbowmen))),
        (7, (1300, Reward::Gold)),
        (8, (700, Reward::Enlist(ArmyName::RoninImmortals))),
        (
            9,
            (700, Reward::Enlist(ArmyName::BarbariansOfTheOuterSteppe)),
        ),
        (10, (1500, Reward::Gold)),
        (11, (700, Reward::Enlist(ArmyName::DeathDealerAssassins))),
        (12, (1700, Reward::Gold)),
        (13, (700, Reward::Enlist(ArmyName::OathSwornKnights))),
        (14, (1900, Reward::Gold)),
        (15, (2000, Reward::Gold)),
        (16, (500, Reward::Enlist(ArmyName::CastlegateCrossbowmen))),
        (17, (2100, Reward::Gold)),
        (18, (2200, Reward::Gold)),
        (19, (500, Reward::Enlist(ArmyName::MagiEnforcers))),
        (20, (2300, Reward::Gold)),
        (21, (700, Reward::Enlist(ArmyName::ShinobiMartialArtists))),
        (22, (2500, Reward::Gold)),
        (23, (2600, Reward::Gold)),
        (24, (2700, Reward::Gold)),
        (25, (700, Reward::Enlist(ArmyName::AvianCliffDwellers))),
        (26, (700, Reward::Enlist(ArmyName::HighbornCavalry))),
        (27, (2900, Reward::Gold)),
        (28, (3000, Reward::Gold)),
        (29, (500, Reward::Enlist(ArmyName::SkullClanDeathCultists))),
    ]);
