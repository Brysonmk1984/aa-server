    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        let sql = "
            INSERT INTO armies VALUES 
                ...
                (DEFAULT, 'Elven Archers', 'TBD', 100, 0.00, FALSE, 100, 0.90,  'piercing', 'leather', 0.25, 10, 0.00, 2.00, 2),
                (DEFAULT, 'Castlegate Crossbowmen', 'TBD', 100, 0.00, FALSE, 75, 0.75, 'piercing', 'chain', 0.15, 5, 0.00, 1.00, 2)
            ";
