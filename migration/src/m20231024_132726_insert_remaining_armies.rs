    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        let sql = "
            INSERT INTO armies VALUES 
                (DEFAULT, 'Barbarians of the Outer Steppe', 'TBD', 100, 0.00, FALSE, 5, 0.90, 'crushing', 'chain', 0.3, 10, 0.00, 1.00, 1),
                (DEFAULT, 'Oath-Sworn Knights', 'TBD', 100, 0.30, FALSE, 5, 0.90,  'edged', 'plate', 0.25, 5, 0.00, 2.00, 1),
                ...
                (DEFAULT, 'Elven Archers', 'TBD', 100, 0.00, FALSE, 100, 0.95,  'piercing', 'leather', 0.25, 10, 0.00, 2.00, 1),
                (DEFAULT, 'Castlegate Crossbowmen', 'TBD', 100, 0.00, FALSE, 75, 0.70, 'piercing', 'chain', 0.15, 5, 0.00, 1.00, 2)
            ";
