...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        let sql = "INSERT INTO armies VALUES (DEFAULT, 'North Glade Longbowmen', 'TBD', 500, 100, 35, 0, 0.0, false, 100), (DEFAULT, 'Highborn Calvary', 'TBD', 250, 75, 100, 50, 5.5, false, 10)";
