...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        from (values
            ...
            ('Imperial Legionnaire', 'TBD', 100, 0.75, FALSE, 10, 1.00, 'edged', 'plate', 0.10, 5, 0.00, 1.00, 1),
            ('North Watch Longbowmen', 'TBD', 100, 0.00, FALSE, 150, 0.50, 'piercing', 'unarmored', 0.10, 5, 0.00, 1.00, 1),
            ...
            ('Shinobi Martial Artists', 'TBD', 100, 0.00, FALSE, 5, 1.00, 'blunt', 'leather', 0.50, 5, 0.00, 1.00, 3),
            ('Amazonian Huntresses', 'TBD', 100, 0.00, FALSE, 5, 1.00, 'piercing', 'leather', 0.35, 10, 0.00, 1.00, 2),
            ('Avian Cliff Dwellers', 'TBD', 100, 0.25, TRUE, 10, 0.90, 'edged', 'leather', 0.25, 10, 0.00, 3.00, 1),
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        from (values
            ...
            ('Imperial Legionnaire', 'TBD', 500, 0.75, FALSE, 10, 1.00, edged, plate, 0.10, 5, 0.00, 1.00, 1),
            ...
            ('Rōnin Immortals', 'TBD', 750, 0.00, FALSE, 5, 1.00, edged, chain, 0.35, 5, 0.00, 1.00, 2),
            ('Shinobi Martial Artists', 'TBD', 750, 0.00, FALSE, 5, 1.00, blunt, leather, 0.50, 5, 0.00, 1.00, 3),
            ('Amazonian Huntresses', 'TBD', 1000, 0.00, FALSE, 5, 1.00, piercing, leather, 0.35, 10, 0.00, 1.00, 2),
            ('Avian Cliff Dwellers', 'TBD', 750, 0.25, TRUE, 10, 0.90, edged, leather, 0.25, 10, 0.00, 3.00, 1),
