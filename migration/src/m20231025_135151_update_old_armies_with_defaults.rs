...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        from (values
            ...
            ('Imperial Legionnaire', 'TBD', 100, 0.60, FALSE, 5, 0.90, 'edged', 'plate', 0.10, 5, 0.00, 1.00, 1),
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        from (values
            ...
            ('Amazonian Huntresses', 'TBD', 1000, 0.00, FALSE, 5, 0.90, piercing, leather, 0.35, 10, 0.00, 1.00, 2),
            ('Avian Cliff Dwellers', 'TBD', 750, 0.25, TRUE, 10, 0.80, edged, leather, 0.25, 10, 0.00, 3.00, 1),
